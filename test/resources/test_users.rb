...
class UsersResourceTest < Minitest::Test
  def test_list
    stub = stub_request(path: "users", response: stub_response(fixture: "users/list"))
  ...
  def test_create
    ...
    stub = stub_request(path: "users", body: body, method: :post, response: stub_response(fixture: "users/create", status: 201))
    client = Vultr::Client.new(api_key: "fake", adapter: :test, stubs: stub)
  ...
  def test_retrieve
    ...
    stub = stub_request(path: "users/#{user_id}", response: stub_response(fixture: "users/retrieve"))
    client = Vultr::Client.new(api_key: "fake", adapter: :test, stubs: stub)
  ...
  def test_update
    user_id = "cb676a46-66fd-4dfb-b839-443f2e6c0b60"
    body = {name: "Changed"}
    stub = stub_request(path: "users/#{user_id}", method: :patch, body: body,
  ...
  def test_delete
    user_id = "cb676a46-66fd-4dfb-b839-443f2e6c0b60"
    stub = stub_request(path: "users/#{user_id}", method: :delete, response: stub_response(fixture: "users/delete"))
    client = Vultr::Client.new(api_key: "fake", adapter: :test, stubs: stub)
